...
> Diagnosing & fixing a stuck embedding-model download (trusting a TLS-intercepting proxy's CA) has moved to Issue: [#20 Stuck embedding-model download: making Python trust a TLS-intercepting proxy's CA](https://github.com/dengxuanliang/uxflow/issues/20).
